...
(function (Event) {
    ...
    Event["PlaybackAnimatedVolumeChanged"] = "playback-animated-volume-changed";
     ...
     * headless setup.
     */
    Event["PlaybackResume"] = "playback-resume-android";
    /**
     ...
     **/
    Event["connectorConnected"] = "android-controller-connected";
    /**
     * Fired when an android connector connects to MusicService.
     * typical controllers are media notification and Android Auto.
     **/
    Event["connectorDisconnected"] = "android-controller-disconnected";
})(Event || (Event = {}));
